      ...
      <div className="relative rounded-md shadow-md p-4 md:p-10 lg:p-16 max-w-6xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-2 gap-2">
          <a href="mailto:shoshanabeer@gmail.com" className="rounded-xl hover:bg-blue-200 dark:hover:bg-blue-900 border-2 py-2 font-medium text-center">
            <Image src='/images/envelope-light.svg' width={25} height={25} alt='Email icon' className="inline pr-1 align-middle" />
          ...
          <a href="https://www.linkedin.com/in/shoshana-beer-493152264/" target="_blank" className="rounded-xl hover:bg-blue-200 dark:hover:bg-blue-900 border-2 py-2 font-medium text-center">
            <Image src='/images/linkedin_light.svg' width={25} height={25} alt='LinkedIn icon' className="inline pr-1 align-middle" />
          ...
          <a href="https://github.com/ShoshBeer" target="_blank" className="rounded-xl hover:bg-blue-200 dark:hover:bg-blue-900 border-2 py-2 font-medium text-center">
            <Image src='/images/github_light.svg' width={25} height={25} alt='GitHub icon' className="inline pr-1 align-middle" />
          ...
          <a onClick={() => alert('Just kidding')} className="rounded-xl hover:bg-blue-200 dark:hover:bg-blue-900 border-2 py-2 font-medium text-center cursor-pointer">
            <Image src='/images/house.svg' width={25} height={25} alt='House icon' className="inline pr-1 align-middle" />
